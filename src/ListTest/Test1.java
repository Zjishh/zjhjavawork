...
public class Test1 {
    public static void main(String[] args) {
        //1.创建集合的对象333任务
        Collection<Studentaa> coll = new ArrayList<>();


        //2.创建三个学生对象
        Studentaa s1 = new Studentaa("zhangsan",23);
        Studentaa s2 = new Studentaa("lisi",24);
        Studentaa s3 = new Studentaa("wangwu",25);
        ...
        //4.判断集合中某一个学生对象是否包含
        Studentaa s4 = new Studentaa("zhangsan",23);
